...
public void slider_changed(GCustomSlider source, GEvent event) { //_CODE_:slider:219774:
  println("slider - GCustomSlider >> GEvent." + event + " @ " + millis());
...
public void createGUI(){
  ...
  imageData = new GTextArea(imageEdit, 0, 40, 400, 380, G4P.SCROLLBARS_BOTH);
  imageData.setOpaque(true);
  imageData.addEventHandler(this, "imageData_changed");
  label1 = new GLabel(imageEdit, 10, 10, 80, 20);
  label1.setText("Data:");
  ...
  slide_label.setText("luminosity");
